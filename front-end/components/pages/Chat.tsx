    ...
    return (
      ...
      >
        <StyledView className="w-full flex flex-col items-center justify-center">
          ...
          <StyledView className="items-start justify-start mr-72 bottom-16"><StyledText className="text-3xl text-white" onPress={()=>  this.navigator.navigate("UserPage")}>←</StyledText></StyledView>
